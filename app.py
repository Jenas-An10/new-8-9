...
def input_window():
    ...
    st.markdown("<h1 style='text-align: center;'>Cancer Detection App</h1>", unsafe_allow_html=True)
...
def result_window():
    ...
    st.markdown("<h1 style='text-align: center;'>Cancer Detection Results</h1>", unsafe_allow_html=True)
